...
const html=fs.readFileSync('/mnt/data/perla_v258_work/PERLA1_V257_RAIN_SKYBOX_DEPTH_ANCHOR_FIX_SAFE_LOCAL/01_GIOCO_PRONTO_LOCAL_TEST/index.html','utf8');
...
setTimeout(()=>{
  const out={buildId:context.window.PERLA_BUILD_ID, hasDebug:!!context.window.__PERLA_DEBUG__, hasPerf:typeof context.window.perlaPerformanceV258==='function', hasSummary:typeof context.window.perlaLastDrawStatsSummaryV258==='function', debugText:document.getElementById('debugLine').textContent, perf: context.window.perlaPerformanceV258 ? context.window.perlaPerformanceV258('node_smoke') : null, rafCount};
