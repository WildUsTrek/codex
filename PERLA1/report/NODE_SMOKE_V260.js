...
const html=fs.readFileSync('/mnt/data/perla_v260_work/PERLA1_V260_LONG_VIEW_SPRITE_FLOOR_BUDGET_SAFE_LOCAL/01_GIOCO_PRONTO_LOCAL_TEST/index.html','utf8');
...
const context={
  ...
  requestAnimationFrame(cb){ if(rafCount++<3) setTimeout(()=>cb(Date.now()),0); return rafCount; },
...
setTimeout(()=>{
  const out={buildId:context.window.PERLA_BUILD_ID, hasDebug:!!context.window.__PERLA_DEBUG__, hasPerf:typeof context.window.perlaPerformanceV258A==='function', hasSmart:typeof context.window.perlaPerfStart==='function', hasV259:typeof context.window.perlaRoofHotspotSummaryV259==='function', hasV260:typeof context.window.perlaLongViewBudgetSummaryV260==='function', toggleV260:typeof context.window.perlaLongViewBudgetToggleV260==='function', downloadV260:typeof context.window.perlaLongViewBudgetDownloadV260==='function', summaryV260: context.window.perlaLongViewBudgetSummaryV260 ? context.window.perlaLongViewBudgetSummaryV260() : null, lastSummary: context.window.perlaLastDrawStatsSummaryV258 ? context.window.perlaLastDrawStatsSummaryV258() : null, rafCount};
