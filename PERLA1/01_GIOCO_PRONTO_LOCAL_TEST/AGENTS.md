...
- Expected V283/V281 debug pattern in affected roof and canopy views:
  - `window.PERLA_BUILD_ID` is `PERLA1_V296_PHYSICAL_TOMBSTONE_PRUNE_SAFE_LOCAL`.
